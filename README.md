...
Welcome to Sudoku SolverPro

Sudoku SolverPro is your go-to solution for effortlessly cracking Sudoku puzzles of varying complexities. Powered by a robust backtracking algorithm and intuitive user interface, Sudoku SolverPro promises precision and efficiency, guiding you through each puzzle with ease.

## Table of Content

- [Overview of the project](#overview-of-the-project)
- [Overview of Backtracking Algorithm](#overview-of-backtracking-algorithm)
...
**An example of a state-tree and how backtracking algorithm works**
...
![State-tree](screenshots/state-tree.png)

**How the backtracking can be used to solve a problem**
...
This is the MVP design of the Sudoku SolverPro
